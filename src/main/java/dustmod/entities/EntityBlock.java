...
public class EntityBlock extends EntityFallingBlock
{
    ...
    protected EntityRune parentDust = null;
...
//        	this.
        ...
        {
            parentDust = EntityRuneManager.getDustAtID(parentDustID);

            if (parentDust != null)
            {
                RuneEvent evt = parentDust.event;
...
//            	System.out.println("DEATH5");
    ...
    public void setParent(EntityRune e){
    	this.parentDust = e;
